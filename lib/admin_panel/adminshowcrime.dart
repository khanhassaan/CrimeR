...
class adminshowcrime extends StatefulWidget {
  final Map<String, dynamic> data;
  adminshowcrime(this.data);
  @override
  _adminshowcrimeState createState() => _adminshowcrimeState();
}

class _adminshowcrimeState extends State<adminshowcrime> {
  int _currentIndex = 0;
